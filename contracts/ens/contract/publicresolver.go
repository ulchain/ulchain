...
import (
	...
	"github.com/epvchain/go-epvchain/accounts/abi"
...
// DeployPublicResolver deploys a new EPVchain contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an EPVchain contract.
...
// PublicResolverCaller is an auto generated read-only Go binding around an EPVchain contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an EPVchain contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverFilterer is an auto generated log filtering Go binding around an EPVchain contract events.
type PublicResolverFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an EPVchain contract,
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an EPVchain contract,
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an EPVchain contract,
...
// PublicResolverRaw is an auto generated low-level Go binding around an EPVchain contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an EPVchain contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an EPVchain contract.
