...
// DeployChequebook deploys a new EPVchain contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an EPVchain contract.
...
// ChequebookCaller is an auto generated read-only Go binding around an EPVchain contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an EPVchain contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookFilterer is an auto generated log filtering Go binding around an EPVchain contract events.
type ChequebookFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an EPVchain contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an EPVchain contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an EPVchain contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an EPVchain contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw methods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an EPVchain contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw methods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an EPVchain contract.
