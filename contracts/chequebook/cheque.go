...
// Package chequebook package wraps the 'chequebook' EPVchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in epvc; (auto)cashing cheques in epvc
// as well as (auto)depositing epvc to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/epvchain/go-epvchain/swarm/services/swap/swap"
)
...
// * depositing epvc to the chequebook
// * watching incoming epvc
...
// Cash cashes the cheque by sending an EPVchain transaction.
