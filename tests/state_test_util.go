...
// See https://github.com/epvchain/EIPs/issues/176 for the test format specification.
...
func MakePreState(db epvdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/epvchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
