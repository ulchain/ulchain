...
type Context struct {
	...
	// sufficient epvc to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers epvc from one account to the other
...
// EVM is the EPVchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) epvchain virtual machine
