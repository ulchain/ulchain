...
//
// epv_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// epv_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.EPVSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "epv_getBlockByNumber", "latest"); err != nil {
