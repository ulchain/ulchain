...
// PublicEPVchainAPI provides an API to access EPVchain related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEPVchainAPI struct {
	b Backend
}

// NewPublicEPVchainAPI creates a new EPVchain protocol API.
...
// ProtocolVersion returns the current EPVchain protocol version this node supports
...
//   keccak256("\x19EPVchain Signed Message:\n"${message length}${message}).
//
...
// Sign calculates an EPVchain ECDSA signature for:
// keccack256("\x19EPVchain Signed Message:\n" + len(message) + message))
//
...
//
// https://github.com/epvchain/go-epvchain/wiki/Management-APIs#personal_sign
...
// Note, this function is compatible with epv_sign and personal_sign. As such it recovers
// the address of:
// hash = keccak256("\x19EPVchain Signed Message:\n"${message length}${message})
// addr = ecrecover(hash, signature)
//
// Note, the signature must conform to the secp256k1 curve R, S and V values, where
// the V value must be be 27 or 28 for legacy reasons.
//
// https://github.com/epvchain/go-epvchain/wiki/Management-APIs#personal_ecRecover
...
// PublicBlockChainAPI provides an API to access the EPVchain blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new EPVchain blockchain API.
...
//
// https://github.com/epvchain/wiki/wiki/JSON-RPC#epv_sign
...
// PublicDebugAPI is the collection of EPVchain APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of EPVchain APIs exposed over the private
// debugging endpoint.
...
// Version returns the current epvchain protocol version.
