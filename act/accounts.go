...
// Package accounts implements high level EPVchain account management.
package accounts
...
// Account represents an EPVchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // EPVchain account address derived from the key
