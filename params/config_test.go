...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllEPVhashProtocolChanges, new: AllEPVhashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllEPVhashProtocolChanges, new: AllEPVhashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllEPVhashProtocolChanges,
