...
import (
	...
	"github.com/epvchain/go-epvchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the EPVchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the EPVchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the EPVchain contract Solidity source to build and bind")
