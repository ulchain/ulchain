...
func (w *wizard) makeServer() string {
	...
	if err != nil {
		log.Error("Server not ready for puppepv", "err", err)
		return ""
	}
...
func (w *wizard) deployComponent() {
	...
	fmt.Println(" 1. EPVstats  - Network monitoring tool")
	fmt.Println(" 2. Bootnode  - Entry point of the network")
	fmt.Println(" 3. Sealer    - Full node minting new blocks")
	fmt.Println(" 4. Explorer  - Chain analysis webservice (epvhash only)")
