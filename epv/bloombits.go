...
const (
	// bloomServiceThreads is the number of goroutines used globally by an EPVchain
...
// for the EPVchain header bloom filters, permitting blazing fast filtering.
type BloomIndexer struct {
	size uint64 // section size to generate bloombits for

	db  epvdb.Database       // database instance to write index data and metadata into
