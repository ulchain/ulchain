...
type downloadTester struct {
	...
	stateDb epvdb.Database // Database used by the tester for syncing from peers
	peerDb  epvdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = epvdb.NewMemDatabase()
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, epvhash.NewFaker(), dl.peerDb, n, func(i int, block *core.BlockGen) {
