...
// PeerInfo represents a short summary of the EPVchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // EPVchain protocol version negotiated
...
// Handshake executes the epv protocol handshake, negotiating version number,
