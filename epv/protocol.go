...
// Supported versions of the epv protocol (first is primary).
...
// epv protocol message codes
const (
	// Protocol messages belonging to epv/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to epv/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
