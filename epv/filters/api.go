...
// information related to the EPVchain protocol such als blocks, transactions and logs.
...
// `epv_getFilterChanges` polling method that is also used for log filters.
//
...
// It is part of the filter package since polling goes with epv_getFilterChanges.
//
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(epvchain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of epvchain.FilterQuery.
