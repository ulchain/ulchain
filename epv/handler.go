...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and EPVchain peer set
...
// handle is the callback invoked to manage the life cycle of an epv peer. When
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	// Execute the EPVchain handshake
	var (
