...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (epv/61) or header (epv/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (epv/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both epv/61 and epv/62)
}
