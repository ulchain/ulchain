...
func newTestLDB() (*epvdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "epvdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := epvdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db epvdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db epvdb.Database, t *testing.T) {
	const n = 8
