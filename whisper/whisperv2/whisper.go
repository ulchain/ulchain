...
import (
	...
	"github.com/epvchain/go-epvchain/crypto/ecies"
	"github.com/epvchain/go-epvchain/event/filter"
...
// Whisper represents a dark communication interface through the EPVchain
...
// New creates a Whisper client ready to communicate through the EPVchain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
