...
import (
	...
	"github.com/epvchain/go-epvchain/logger"
	"github.com/epvchain/go-epvchain/p2p"
	"github.com/epvchain/go-epvchain/p2p/nat"
	"github.com/epvchain/go-epvchain/whisper"
)
...
func main() {
	...
	// Create an EPVchain peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting EPVchain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start EPVchain peer: %v.\n", err)
		os.Exit(1)
	}
