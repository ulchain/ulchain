...
func TestTxPool(t *testing.T) {
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, epvhash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, epvhash.NewFullFaker())
	txPermanent = 50
