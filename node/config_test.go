...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gepv.ipc", false, filepath.Join(os.TempDir(), "gepv.ipc")},
		{"data", "gepv.ipc", false, "data/gepv.ipc"},
		{"data", "./gepv.ipc", false, "./gepv.ipc"},
		{"data", "/gepv.ipc", false, "/gepv.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gepv.ipc", true, `\\.\pipe\gepv.ipc`},
		{"data", "gepv.ipc", true, `\\.\pipe\gepv.ipc`},
		{"data", `\\.\pipe\gepv.ipc`, true, `\\.\pipe\gepv.ipc`},
	}
