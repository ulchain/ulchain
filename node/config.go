...
import (
	...
	"github.com/epvchain/go-epvchain/accounts/usbwallet"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of gepv is "gepv". If no
...
func (c *Config) NodeName() string {
	name := c.name()
	// Backwards compatibility: previous versions used title-cased "Gepv", keep that.
...
// These resources are resolved differently for "gepv" instances.
...
func (c *Config) resolvePath(path string) string {
	...
	// by gepv 1.4 are used if they exist.
