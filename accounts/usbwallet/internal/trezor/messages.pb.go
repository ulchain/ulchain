...
// *
// Request: Ask device for EPVchain address corresponding to address_n path
// @next PassphraseRequest
// @next EPVchainAddress
// @next Failure
...
// *
// Response: Contains an EPVchain address derived from device private seed
// @prev EPVchainGetAddress
