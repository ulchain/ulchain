...
// Package bind generates EPVchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-epvchain Wiki page:
// https://github.com/epvchain/go-epvchain/wiki/Native-DApps:-Go-bindings-to-EPVchain-contracts
package bind
