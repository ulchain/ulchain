...
// See https://github.com/epvchain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given EPVchain presale wallet and stores
