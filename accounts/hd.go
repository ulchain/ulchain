...
// the `coin_type` 60' (or 0x8000003C) to EPVchain.
//
// The root path for EPVchain is m/44'/60'/0'/0 according to the specification
// from https://github.com/epvchain/EIPs/issues/84, albeit it's not set in stone
