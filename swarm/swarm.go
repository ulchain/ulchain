...
import (
	...
	"github.com/epvchain/go-epvchain/contracts/chequebook"
	...
	"github.com/epvchain/go-epvchain/swarm/api"
	httpapi "github.com/epvchain/go-epvchain/swarm/api/http"
	"github.com/epvchain/go-epvchain/swarm/fuse"
	"github.com/epvchain/go-epvchain/swarm/network"
	"github.com/epvchain/go-epvchain/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *epvclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
