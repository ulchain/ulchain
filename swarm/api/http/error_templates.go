...
<html>
  ...
  <head>
    ...
    <meta name="description" content="EPVchain/Swarm error page">
    <meta property="og:url" content="https://swarm-gateways.net/bzz:/theswarm.epv">
    ...
    <div class="container">
      ...
      <footer>
        <p>
          ...
          <a href="http://swarm-gateways.net/bzz:/theswarm.epv">Swarm</a>
        </p>
      </footer>
...
<html>
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" ww="chrome=1">
    <meta name="description" content="EPVchain/Swarm multiple options page">
    <meta property="og:url" content="https://swarm-gateways.net/bzz:/theswarm.epv">
		<link rel="shortcut icon" type="image/x-icon" href="data:image/png;base64,"/>
    <style>
