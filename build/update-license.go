...
var (
	...
	authorsFileHeader = "# This is the official list of go-epvchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-epvchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-epvchain library"
	}
	return "the go-epvchain library"
}
