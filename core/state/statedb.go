...
// Package state provides a caching layer atop the EPVchain state trie.
package state
...
// StateDBs within the epvchain protocol are used to store anything
...
//
// Carrying over the balance ensures that EPVC doesn't disappear.
