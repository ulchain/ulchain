...
// account array.
func checkStateAccounts(t *testing.T, db epvdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db epvdb.Database, root common.Hash) error {
...
func checkStateConsistency(db epvdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(epvdb.Database), srcRoot)
