...
// stateObject represents an EPVchain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of epvchain address of the account
	data     Account
	db       *StateDB
...
// Account is the EPVchain consensus representation of accounts.
