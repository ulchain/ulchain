...
// Package core implements the EPVchain consensus protocol.
package core
...
type BlockChain struct {
	...
	db     epvdb.Database // Low level persistent database to store final content in
...
// available in the database. It initialises the default EPVchain Validator and
// Processor.
