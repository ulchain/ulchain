...
// DefaultGenesisBlock returns the EPVchain main net genesis block.
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.MainnetChainConfig,
		Timestamp:  1521859350,
...
// DeveloperGenesisBlock returns the 'gepv --dev' genesis block. Note, this must
// be seeded with the
