...
#define DUK_TYPE_MASK_THROW               (1U << 10)  
#define DUK_TYPE_MASK_PROMOTE             (1U << 11)  

#define DUK_HINT_NONE                     0    
#define DUK_HINT_STRING                   1    
#define DUK_HINT_NUMBER                   2    

#define DUK_ENUM_INCLUDE_NONENUMERABLE    (1U << 0)    
#define DUK_ENUM_INCLUDE_HIDDEN           (1U << 1)    
#define DUK_ENUM_INCLUDE_SYMBOLS          (1U << 2)    
#define DUK_ENUM_EXCLUDE_STRINGS          (1U << 3)    
#define DUK_ENUM_OWN_PROPERTIES_ONLY      (1U << 4)    
#define DUK_ENUM_ARRAY_INDICES_ONLY       (1U << 5)    

#define DUK_ENUM_SORT_ARRAY_INDICES       (1U << 6)    
#define DUK_ENUM_NO_PROXY_BEHAVIOR        (1U << 7)    
...
#define DUK_COMPILE_FUNCEXPR              (1U << 12)   

#define DUK_DEFPROP_WRITABLE              (1U << 0)    
#define DUK_DEFPROP_ENUMERABLE            (1U << 1)    
#define DUK_DEFPROP_CONFIGURABLE          (1U << 2)    
#define DUK_DEFPROP_HAVE_WRITABLE         (1U << 3)    
#define DUK_DEFPROP_HAVE_ENUMERABLE       (1U << 4)    
#define DUK_DEFPROP_HAVE_CONFIGURABLE     (1U << 5)    
#define DUK_DEFPROP_HAVE_VALUE            (1U << 6)    
#define DUK_DEFPROP_HAVE_GETTER           (1U << 7)    
#define DUK_DEFPROP_HAVE_SETTER           (1U << 8)    
#define DUK_DEFPROP_FORCE                 (1U << 9)    
...
#define duk_push_thread(ctx) \
	duk_push_thread_raw((ctx), 0 )

#define duk_push_thread_new_globalenv(ctx) \
	duk_push_thread_raw((ctx), DUK_THREAD_NEW_GLOBAL_ENV )
...
#define DUK_BUF_FLAG_NOZERO    (1 << 2)    
...
#define DUK_BUF_MODE_FIXED      0   
#define DUK_BUF_MODE_DYNAMIC    1   
#define DUK_BUF_MODE_DONTCARE   2   
...
#define duk_eval(ctx)  \
	((void) duk_eval_raw((ctx), NULL, 0, 1  | DUK_COMPILE_EVAL | DUK_COMPILE_NOFILENAME))

#define duk_eval_noresult(ctx)  \
	((void) duk_eval_raw((ctx), NULL, 0, 1  | DUK_COMPILE_EVAL | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_peval(ctx)  \
	(duk_eval_raw((ctx), NULL, 0, 1  | DUK_COMPILE_EVAL | DUK_COMPILE_SAFE | DUK_COMPILE_NOFILENAME))

#define duk_peval_noresult(ctx)  \
	(duk_eval_raw((ctx), NULL, 0, 1  | DUK_COMPILE_EVAL | DUK_COMPILE_SAFE | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_compile(ctx,flags)  \
	((void) duk_compile_raw((ctx), NULL, 0, 2  | (flags)))

#define duk_pcompile(ctx,flags)  \
	(duk_compile_raw((ctx), NULL, 0, 2  | (flags) | DUK_COMPILE_SAFE))

#define duk_eval_string(ctx,src)  \
	((void) duk_eval_raw((ctx), (src), 0, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NOFILENAME))

#define duk_eval_string_noresult(ctx,src)  \
	((void) duk_eval_raw((ctx), (src), 0, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_peval_string(ctx,src)  \
	(duk_eval_raw((ctx), (src), 0, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NOFILENAME))

#define duk_peval_string_noresult(ctx,src)  \
	(duk_eval_raw((ctx), (src), 0, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_compile_string(ctx,flags,src)  \
	((void) duk_compile_raw((ctx), (src), 0, 0  | (flags) | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NOFILENAME))

#define duk_compile_string_filename(ctx,flags,src)  \
	((void) duk_compile_raw((ctx), (src), 0, 1  | (flags) | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN))

#define duk_pcompile_string(ctx,flags,src)  \
	(duk_compile_raw((ctx), (src), 0, 0  | (flags) | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN | DUK_COMPILE_NOFILENAME))

#define duk_pcompile_string_filename(ctx,flags,src)  \
	(duk_compile_raw((ctx), (src), 0, 1  | (flags) | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_STRLEN))

#define duk_eval_lstring(ctx,buf,len)  \
	((void) duk_eval_raw((ctx), buf, len, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_NOSOURCE | DUK_COMPILE_NOFILENAME))

#define duk_eval_lstring_noresult(ctx,buf,len)  \
	((void) duk_eval_raw((ctx), buf, len, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_NOSOURCE | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_peval_lstring(ctx,buf,len)  \
	(duk_eval_raw((ctx), buf, len, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_NOSOURCE | DUK_COMPILE_SAFE | DUK_COMPILE_NOFILENAME))

#define duk_peval_lstring_noresult(ctx,buf,len)  \
	(duk_eval_raw((ctx), buf, len, 0  | DUK_COMPILE_EVAL | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_NORESULT | DUK_COMPILE_NOFILENAME))

#define duk_compile_lstring(ctx,flags,buf,len)  \
	((void) duk_compile_raw((ctx), buf, len, 0  | (flags) | DUK_COMPILE_NOSOURCE | DUK_COMPILE_NOFILENAME))
...
#define duk_pcompile_lstring(ctx,flags,buf,len)  \
	(duk_compile_raw((ctx), buf, len, 0  | (flags) | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE | DUK_COMPILE_NOFILENAME))

#define duk_pcompile_lstring_filename(ctx,flags,buf,len)  \
	(duk_compile_raw((ctx), buf, len, 1  | (flags) | DUK_COMPILE_SAFE | DUK_COMPILE_NOSOURCE))
...
#define DUK_DATE_IDX_YEAR           0  
#define DUK_DATE_IDX_MONTH          1  
#define DUK_DATE_IDX_DAY            2  
#define DUK_DATE_IDX_HOUR           3
#define DUK_DATE_IDX_MINUTE         4
#define DUK_DATE_IDX_SECOND         5
#define DUK_DATE_IDX_MILLISECOND    6
#define DUK_DATE_IDX_WEEKDAY        7  
#define DUK_DATE_IDX_NUM_PARTS      8

#define DUK_DATE_FLAG_NAN_TO_ZERO          (1 << 0)  
#define DUK_DATE_FLAG_NAN_TO_RANGE_ERROR   (1 << 1)  
#define DUK_DATE_FLAG_ONEBASED             (1 << 2)  
#define DUK_DATE_FLAG_EQUIVYEAR            (1 << 3)  
#define DUK_DATE_FLAG_LOCALTIME            (1 << 4)  
#define DUK_DATE_FLAG_SUB1900              (1 << 5)  
#define DUK_DATE_FLAG_TOSTRING_DATE        (1 << 6)  
#define DUK_DATE_FLAG_TOSTRING_TIME        (1 << 7)  
#define DUK_DATE_FLAG_TOSTRING_LOCALE      (1 << 8)  
#define DUK_DATE_FLAG_TIMESETTER           (1 << 9)  
#define DUK_DATE_FLAG_YEAR_FIXUP           (1 << 10) 
#define DUK_DATE_FLAG_SEP_T                (1 << 11) 
#define DUK_DATE_FLAG_VALUE_SHIFT          12        
