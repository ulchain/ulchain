...
// Contains all the wrappers from the go-epvchain root package.
...
// the EPVchain network.
type SyncProgress struct {
	progress epvchain.SyncProgress
}
