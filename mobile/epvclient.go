...
// Contains a wrapper for the EPVchain client.
...
import (
	...
	"github.com/epvchain/go-epvchain/epvclient"
)

// EPVchainClient provides access to the EPVchain APIs.
type EPVchainClient struct {
	client *epvclient.Client
}

// NewEPVchainClient connects a client to the given URL.
func NewEPVchainClient(rawurl string) (client *EPVchainClient, _ error) {
	rawClient, err := epvclient.Dial(rawurl)
	return &EPVchainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EPVchainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *EPVchainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *EPVchainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *EPVchainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *EPVchainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *EPVchainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *EPVchainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *EPVchainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *EPVchainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *EPVchainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *EPVchainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *EPVchainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *EPVchainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *EPVchainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *EPVchainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *EPVchainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *EPVchainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *EPVchainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EPVchainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *EPVchainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *EPVchainClient) SendTransaction(ctx *Context, tx *Transaction) error {
