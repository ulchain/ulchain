...
// EPVhash proof-of-work protocol constants.
var (
...
// rules of the stock EPVchain epvhash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/epvchain/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/epvchain/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/epvchain/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
// header to conform to the epvhash protocol. The changes are done inline.
