...
import (
	...
	"github.com/epvchain/go-epvchain/consensus/misc"
...
// ecrecover extracts the EPVchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the EPVchain address
...
// EPVchain testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     epvdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // EPVchain address of the signing key
...
func New(config *params.CliqueConfig, db epvdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the EPVchain address recovered
