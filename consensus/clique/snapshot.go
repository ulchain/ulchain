...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db epvdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db epvdb.Database) error {
