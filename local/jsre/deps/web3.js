...
module.exports = {
    EPV_PADDING: 32,
    EPV_SIGNATURE_LENGTH: 4,
    EPV_UNITS: EPV_UNITS,
    EPV_BIGNUMBER_ROUNDING_MODE: { ROUNDING_MODE: BigNumber.ROUND_DOWN },
    EPV_POLLING_TIMEOUT: 1000/2,
    defaultBlock: 'latest',
...
var unitMap = {
    ...
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'microepvc':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'milliepvc':    '1000000000000000',
    'milli':         '1000000000000000',
    'epvc':        '1000000000000000000',
    'kepvc':       '1000000000000000000000',
    'grand':        '1000000000000000000000',
    'mepvc':       '1000000000000000000000000',
    'gepvc':       '1000000000000000000000000000',
...
var EPV = require('./web3/methods/epv');
...
var properties = function () {
    return [
        ...
        new Property({
            name: 'version.epvchain',
            getter: 'epv_protocolVersion',
            inputFormatter: utils.toDecimal
        }),
        new Property({
...
var addFunctionsToContract = function (contract) {
    contract.abi.filter(function (json) {
        ...
        return new SolidityFunction(contract._epv, json, contract.address);
    }).forEach(function (f) {
...
var addEventsToContract = function (contract) {
    ...
    var All = new AllEvents(contract._epv._requestManager, events, contract.address);
    All.attachToContract(contract);

    events.map(function (json) {
        return new SolidityEvent(contract._epv._requestManager, json, contract.address);
    }).forEach(function (e) {
...
SolidityFunction.prototype.call = function () {
    ...
    var self = this;
    this._epv.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return this._epv.sendTransaction(payload);
    }
...
SolidityFunction.prototype.estimateGas = function () {
    ...
    if (!callback) {
        return this._epv.estimateGas(payload);
    }
...
SolidityFunction.prototype.request = function () {
    ...
    return {
        method: this._constant ? 'epv_call' : 'epv_sendTransaction',
        callback: callback,
        params: [payload],
        format: format
    };
...
var blockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? "epv_getBlockByHash" : "epv_getBlockByNumber";
};

var transactionFromBlockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'epv_getTransactionByBlockHashAndIndex' : 'epv_getTransactionByBlockNumberAndIndex';
};

var uncleCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'epv_getUncleByBlockHashAndIndex' : 'epv_getUncleByBlockNumberAndIndex';
};

var getBlockTransactionCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'epv_getBlockTransactionCountByHash' : 'epv_getBlockTransactionCountByNumber';
};

var uncleCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'epv_getUncleCountByBlockHash' : 'epv_getUncleCountByBlockNumber';
};
...
Object.defineProperty(EPV.prototype, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(EPV.prototype, 'defaultAccount', {
    get: function () {
...
var methods = function () {
    ...
    var getTransactionReceipt = new Method({
        ...
        call: 'epv_getTransactionReceipt',
        params: 1,
...
EPV.prototype.contract = function (abi) {
    var factory = new Contract(this, abi);
    return factory;
};

EPV.prototype.filter = function (options, callback, filterCreationErrorCallback) {
    return new Filter(options, 'epv', this._requestManager, watches.epv(), formatters.outputLogFormatter, callback, filterCreationErrorCallback);
};

EPV.prototype.namereg = function () {
    return this.contract(namereg.global.abi).at(namereg.global.address);
};

EPV.prototype.icapNamereg = function () {
    return this.contract(namereg.icap.abi).at(namereg.icap.address);
};

EPV.prototype.isSyncing = function (callback) {
...
var epv = function () {
    var newFilterCall = function (args) {
        ...
        switch(type) {
            case 'latest':
                args.shift();
                this.params = 0;
                return 'epv_newBlockFilter';
            case 'pending':
                args.shift();
                this.params = 0;
                return 'epv_newPendingTransactionFilter';
            default:
                return 'epv_newFilter';
        }
    };
    ...
    var uninstallFilter = new Method({
        ...
        call: 'epv_uninstallFilter',
        params: 1
    });

    var getLogs = new Method({
        name: 'getLogs',
        call: 'epv_getFilterLogs',
        params: 1
    });

    var poll = new Method({
        name: 'poll',
        call: 'epv_getFilterChanges',
        params: 1
    });
...
var transfer = function (epv, from, to, value, callback) {
    ...
    if (iban.isDirect()) {
        return transferToAddress(epv, from, iban.address(), value, callback);
    }

    if (!callback) {
        var address = epv.icapNamereg().addr(iban.institution());
        return deposit(epv, from, address, value, iban.client());
    }

    epv.icapNamereg().addr(iban.institution(), function (err, address) {
        return deposit(epv, from, address, value, iban.client(), callback);
    });
