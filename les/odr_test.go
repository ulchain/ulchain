...
import (
	...
	"github.com/epvchain/go-epvchain/light"
	"github.com/epvchain/go-epvchain/params"
	"github.com/epvchain/go-epvchain/rlp"
)

type odrTestFn func(ctx context.Context, db epvdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte

func TestOdrGetBlockLes1(t *testing.T) { testOdr(t, 1, 1, odrGetBlock) }

func TestOdrGetBlockLes2(t *testing.T) { testOdr(t, 2, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db epvdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrGetReceipts(ctx context.Context, db epvdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrAccounts(ctx context.Context, db epvdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrContractCall(ctx context.Context, db epvdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func testOdr(t *testing.T, protocol int, expFail uint64, fn odrTestFn) {
	...
	odr := NewLesOdr(ldb, light.NewChtIndexer(db, true), light.NewBloomTrieIndexer(db, true), epv.NewBloomIndexer(db, light.BloomTrieFrequency), rm)
