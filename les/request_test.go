...
type accessTestFn func(db epvdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db epvdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db epvdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db epvdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db epvdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
