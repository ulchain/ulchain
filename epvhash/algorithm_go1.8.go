...
// cacheSize returns the size of the epvhash verification cache that belongs to a certain
// block number.
...
// datasetSize returns the size of the epvhash mining dataset that belongs to a certain
// block number.
