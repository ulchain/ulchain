...
// cacheSize calculates and returns the size of the epvhash verification cache that
...
// datasetSize calculates and returns the size of the epvhash mining dataset that
