	...
	if len(body.UncleHashes) > 0 {
		...
		for i := range reqs {
			reqs[i] = rpc.BatchElem{
				Method: "epv_getUncleByBlockHashAndIndex",
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, epvchain.NotFound
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "epv_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func toFilterArg(q epvchain.FilterQuery) interface{} {
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	return ec.c.CallContext(ctx, nil, "epv_sendRawTransaction", common.ToHex(data))
}

func toCallArg(msg epvchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
